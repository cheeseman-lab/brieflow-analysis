...
def _(
    ...
    ph_test_metadata_fp = ROOT_FP / 'preprocess' / 'metadata' / 'phenotype' / get_filename(ph_filename_params, 'combined_metadata', 'parquet')
    ...
    sbs_test_metadata_fp = ROOT_FP / 'preprocess' / 'metadata' / 'sbs' / get_filename(sbs_filename_params, 'combined_metadata', 'parquet')
    ...
    _phenotype_info_fp = ROOT_FP / 'phenotype' / 'parquets' / get_filename({'plate': TEST_PLATE, 'well': TEST_WELL}, 'phenotype_info', 'parquet')
    phenotype_info = pd.read_parquet(_phenotype_info_fp)
    _sbs_info_fp = ROOT_FP / 'sbs' / 'parquets' / get_filename({'plate': TEST_PLATE, 'well': TEST_WELL}, 'sbs_info', 'parquet')
